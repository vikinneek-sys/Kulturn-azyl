...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'editor', 'redaktor');
  CREATE TYPE "public"."enum_articles_status" AS ENUM('draft', 'review', 'published');
  CREATE TYPE "public"."enum__articles_v_version_status" AS ENUM('draft', 'review', 'published');
  ...
  CREATE TABLE "users" (
  	...
  	"role" "enum_users_role" DEFAULT 'redaktor' NOT NULL,
  	"bio" varchar,
  	"avatar_id" integer,
